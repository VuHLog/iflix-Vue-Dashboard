...
<template>
  <div id="" class="card">
    ...
    >
      <span class="text-h5">Bảng danh mục</span>
      <div class="btn btn-success">
        <font-awesome-icon :icon="['fas', 'plus']" />
        <router-link to="/createCategories">
    ...
    <div class="card-body px-0 pt-0 pb-2">
      ...
      <div class="table-responsive p-0">
        <table class="table align-items-center mb-0">
          ...
          <tbody>
            <template v-for="(c, index) in categories" :key="categories.id">
              <tr>
                <td>
                ...
                <td class="align-middle text-start">
                  <div class="d-flex">
                    <div class="icon-edit">
                      <router-link :to="'/editCategories/' + c.id">
                    ...
                    <div class="icon-delete ml-4">
                      <div class="text-red" @click="deleteCategories(c.id)">
